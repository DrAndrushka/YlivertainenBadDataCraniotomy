...
SCHEMA = [
    ...
    ColSpec(name="izsaukuma_laiks",
            kind="datetime",
            keep=False),
    ColSpec(name="iestasanas_laiks",
            kind="datetime",
            keep=False),
    ColSpec(name="nogadasana_PSKUS_laiks",
            kind="datetime", 
            keep=False),
    ColSpec(name="izrakstisanas_laiks",
            kind="datetime",
            keep=False),
    ColSpec(name="discharged_how",
            kind="categorical",
            keep=True),
    ColSpec(name="patient_surname",
            kind="categorical",
            keep=True),
...
DERIVED = [
    ColSpec(name="lidzPSKUS_timedelta_minutes",
            ...
            keep=False),
    ColSpec(name="lidzizrakstisanai_timedelta_days",
            kind="timedelta",
            timedelta_units='days',
            derive_from=("iestasanas_laiks", "izrakstisanas_laiks"),
            keep=False),
